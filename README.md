...
Currently at [Clover Next](https://cloverorthopedics.com/en/home-en/), building a cloud-based clinical platform for musculoskeletal care.
Before that, I spent six years at [WeWear](https://wewear.tech) on 3D configurators and size technology for digital fashion.

## Selected projects

**[WE3D Configurator](https://wewear.tech/en/3d-configurator)** — A Three.js platform with a built-in
editor, letting teams assemble configurable 3D experiences for any product — shoes, clothing, and more.

**[SizeFlow Widget](https://wewear.tech/en/sizeflow)** — A widget that works out the right size from
the shopper's body measurements, right on the product page.

**[Modesto Bertotto](https://www.modestobertotto.com/en/pages/configuratore-3d)** — A configurator
rendered in Unreal Engine and delivered over pixel streaming, wrapped in a Next.js frontend.
...
![TSL Shaders](https://img.shields.io/badge/TSL_Shaders-1A1A1A?style=flat-square)
...
![Better Auth](https://img.shields.io/badge/Better_Auth-000000?style=flat-square&logo=betterauth&logoColor=white)
